export default {
  ...
  contact: {
    title: 'Contact Us',
    description: 'Contact customer support on WeChat',
    wechatLabel: 'Customer Support WeChat',
    helpTitle: 'Need help? Contact us',
    helpDescription: 'For help with usage, recharge, subscriptions, or account-related questions, please contact us on WeChat.',
    scanHint: 'Scan the code in WeChat and briefly describe your question. Our support team will reply as soon as possible.',
    wechatImageAlt: 'Customer support WeChat QR code'
  },
  ...
  payment: {
    title: 'Recharge / Subscription',
    rechargeRateNotice: 'Site rate: recharge ¥1 = ${usd} balance',
    currentBalanceEditorial: 'CURRENT BALANCE',
    amountLabel: 'Amount',
    ...
    lottery: {
      ...
      activityLabel: 'Blind-box activity',
      description: 'Every completed balance recharge earns one box. Larger recharges unlock higher balance rewards and rarity caps.',
      recharge: 'Recharge',
      fullRules: 'Full Activity Rules',
      pendingLabel: 'Ready',
      boxUnit: 'blind boxes',
      summaryPendingHint: 'Delivered after recharge completion',
      summaryTrigger: 'How to earn',
      summaryTriggerValue: 'Every completed balance recharge earns one blind box',
      summaryReward: 'Reward delivery',
      summaryRewardValue: 'Claimed rewards are added directly to your balance',
      pendingCount: '{count} to open',
      pendingTitle: 'Your Blind Boxes',
      unopenedLabel: 'UNOPENED · READY',
      balanceBox: 'Balance Blind Box',
      credited: 'Recharge',
      maxRarity: 'Rarity cap',
      order: 'Order #{id}',
      open: 'Open Blind Box',
      emptyTitle: 'No blind boxes waiting',
      noPending: 'No blind boxes are waiting. Complete another balance recharge to earn one.',
      recentResults: 'Recent Rewards',
      rewardLog: 'REWARD LOG',
      historyRecharge: '${amount} recharge',
      noResults: 'No blind-box rewards yet.',
      loadFailed: 'Failed to load blind-box information',
      drawFailed: 'Failed to open the blind box',
      readyEyebrow: 'Recharge gift ready',
      rechargeCreditedAmount: '${amount} recharge credited',
      claimDescription: 'Click the gift to claim this blind-box reward. Closing does not issue it; you can claim it later from Blind Box Draw.',
      rarityCap: 'Rarity cap: {rarity}',
      claimNow: 'Claim blind-box reward',
      tapGift: 'Click the gift to claim',
      claiming: 'Claiming...',
      claimLater: 'Claim later',
      claimedEyebrow: 'Reward credited',
      claimedTitle: 'Blind box claimed',
      rechargeCredited: 'Recharge credited',
      blindBoxReward: 'Blind-box reward',
      claimedDescription: 'The blind-box reward was added to your balance and is shown separately from the recharge.',
      done: 'Done',
      rarity: {
        common: 'Common',
        rare: 'Rare',
    ...
    result: {
      ...
      carpoolSuccess: 'Carpool Joined Successfully',
    ...
    carpool: {
      label: 'Shared Account Subscription',
      title: 'Split the cost, use a dedicated group',
      description: 'Each carpool uses a dedicated account outside the public account pool. Once full, an administrator purchases a Pro 20x account and opens the dedicated group {groupName}. If the group does not form, the administrator will issue a full refund to the original payment method. The 30-day service period starts when service is activated. Generating illegal or prohibited content is strictly forbidden; account restrictions or bans caused by user violations are non-refundable. For official restrictions or bans not caused by user violations, refund eligibility is decided by the provider. If the provider approves the request, the refund is calculated from the amount paid and remaining service days.',
      groupName: '[codex] [Carpool Only] codex-pro, multiplier 0',
      formationWindow: 'Forms within 48 hours of the first payment',
      planName: '{count}-Person Plan',
      credentialsAvailable: 'Credentials Available',
      person: 'person',
      servicePeriod: '30-day service period, with the same 5-hour and 7-day quotas as the official plan.',
      progress: 'Current Progress',
      remaining: '{count} more needed',
      formed: 'Group formed',
      deadline: 'Deadline {time}',
      immediateFormation: 'Forms immediately after payment',
      join: 'Join Carpool',
      noPlans: 'No carpool plans are currently available.',
      alipayUnavailable: 'No CNY Alipay channel is currently available for carpool purchases.',
      myGroups: 'My Carpools',
      waitingDetail: '{count} more needed; deadline {time}',
      purchasingDetail: 'Group formed. The administrator is purchasing the account and will open a dedicated group shortly.',
      activeDetail: 'Dedicated group active until {time}',
      notFormedDetail: 'The group did not form within 48 hours and is waiting for an original-method refund.',
      refundPendingDetail: 'Waiting for an administrator to process the refund.',
      refundedDetail: 'The refund has been processed through the original payment method.',
      expiredDetail: 'The 30-day service period has ended.',
      status: {
        waiting: 'Forming',
    ...
    errors: {
      ...
      INVALID_CARPOOL_PLAN: 'Invalid carpool plan.',
      INVALID_CARPOOL_PLAN_AMOUNT: 'The plan total must be positive and use at most two decimal places.',
      INVALID_CARPOOL_PLAN_MEMBERS: 'Target members must be a positive integer.',
      INVALID_CARPOOL_PLAN_NOTE: 'Plan note is required.',
      CARPOOL_PLAN_NOT_FOUND: 'Carpool plan not found.',
      CARPOOL_PLAN_CHANGED: 'The carpool plan changed. Refresh and place the order again.',
      CARPOOL_PLAN_IN_USE: 'This plan has an active order or waiting group and cannot be changed or deleted.',
      CARPOOL_ALIPAY_ONLY: 'Carpool subscriptions only support Alipay.',
      CARPOOL_CNY_ONLY: 'Carpool subscriptions require a CNY payment channel.',
      CARPOOL_PENDING_ORDER_EXISTS: 'Complete or cancel the current pending carpool order first.',
      CARPOOL_ALREADY_JOINED: 'You already have a seat in the current carpool group.',
      CARPOOL_GROUP_CHANGED: 'The current carpool group changed. Refresh and try again.',
      INVALID_CARPOOL_STATUS: 'The current carpool status does not allow this operation.',
      INVALID_CARPOOL_PERIOD: 'The carpool service period is invalid.',
    ...
    admin: {
      ...
      carpoolOrder: 'Carpool Subscription',
      paidAt: 'Paid At',
      ...
      carpool: {
        current: 'Current Carpools',
        history: 'History',
        planConfig: 'Plan Configuration',
        empty: 'No carpool records',
        noPlans: 'No carpool plans',
        createPlan: 'Create Plan',
        editPlan: 'Edit Plan',
        deletePlan: 'Delete Plan',
        deletePlanConfirm: 'Delete this plan? Existing carpool history will remain unchanged.',
        totalAmount: 'Group Total',
        groupSize: 'Target Members',
        perMemberAmount: 'Per Member',
        perMemberPreview: 'Each user pays {amount}',
        planNote: 'Plan Note',
        planNotePlaceholder: 'Enter formation, delivery, violation, and refund rules',
        updatedAt: 'Updated At',
        members: 'paid members',
        deadline: 'Formation Deadline',
        formedAt: 'Formed At',
        openedAt: 'Opened At',
        serviceExpiresAt: 'Service Expires',
        statusReason: 'Status Reason',
        markOpened: 'Mark Opened',
        markRefundPending: 'Start Refund Processing',
        openDialogTitle: 'Confirm Carpool Activation',
        openDialogMessage: 'Confirm that the account and dedicated group are ready. The 30-day service period starts immediately.',
        refundPendingDialogTitle: 'Confirm Refund Processing',
        refundAmountHint: 'Refund the full amount if formation failed. After official approval, enter the amount prorated by remaining service days.',
        notFormed: 'Not formed within 48 hours',
        notFormedRefundReason: 'Not formed within 48 hours; full original-method refund',
      },
