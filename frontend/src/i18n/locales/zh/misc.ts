export default {
  ...
  contact: {
    title: '联系我们',
    description: '通过微信联系客服',
    wechatLabel: '客服微信',
    helpTitle: '有问题，欢迎联系我们',
    helpDescription: '如果您在使用过程中遇到问题，或需要咨询充值、订阅、账号等相关事项，请通过微信联系我们。',
    scanHint: '请使用微信扫码添加客服，并简单备注您的问题，客服看到后会尽快回复。',
    wechatImageAlt: '客服微信二维码'
  },
  ...
  payment: {
    title: '充值/订阅',
    rechargeRateNotice: '本站汇率：充值 ¥1 = 余额 ${usd}',
    currentBalanceEditorial: 'CURRENT BALANCE · 当前余额',
    amountLabel: '充值金额',
    paymentAmount: '支付金额',
    ...
    lottery: {
      title: '盲盒抽奖',
      activityLabel: '盲盒玩法',
      description: '每笔余额充值到账后获得 1 次开启机会，充值越多，余额奖励和稀有度上限越高。',
      recharge: '去充值',
      fullRules: '完整活动规则',
      pendingLabel: '待开启',
      boxUnit: '个盲盒',
      summaryPendingHint: '充值完成后自动送达',
      summaryTrigger: '获取方式',
      summaryTriggerValue: '每笔余额充值到账送 1 个盲盒',
      summaryReward: '发放方式',
      summaryRewardValue: '点击领取后直接加入账户余额',
      pendingCount: '{count} 次待开启',
      pendingTitle: '你的盲盒',
      unopenedLabel: 'UNOPENED · 待开启',
      balanceBox: '余额盲盒',
      credited: '本笔到账',
      maxRarity: '最高可开',
      order: '订单 #{id}',
      open: '开启盲盒',
      emptyTitle: '还没有待开启盲盒',
      noPending: '当前没有待开启盲盒，完成下一笔余额充值即可获得。',
      recentResults: '最近奖励',
      rewardLog: 'REWARD LOG',
      historyRecharge: '本笔充值 ${amount}',
      noResults: '尚无盲盒奖励记录。',
      loadFailed: '盲盒信息加载失败',
      drawFailed: '盲盒开启失败',
      readyEyebrow: '充值礼盒已送达',
      rechargeCreditedAmount: '充值到账 ${amount}',
      claimDescription: '点击礼盒领取本次盲盒奖励。关闭后不会发放，可稍后在盲盒抽奖页面领取。',
      rarityCap: '本次最高稀有度：{rarity}',
      claimNow: '领取盲盒奖励',
      tapGift: '点击礼盒领取',
      claiming: '正在领取...',
      claimLater: '暂不领取',
      claimedEyebrow: '奖励已到账',
      claimedTitle: '盲盒领取成功',
      rechargeCredited: '充值到账',
      blindBoxReward: '盲盒奖励',
      claimedDescription: '盲盒奖励已加入余额，并与本笔充值金额分开展示。',
      done: '完成',
      rarity: {
        common: '普通',
        rare: '稀有',
    ...
    carpool: {
      label: '共享账号订阅',
      title: '按人数分摊，独立成组使用',
      description: '每个拼车团对应一个独立账号，不进入公共号池。达到套餐人数后由管理员采购账号，账号均为Pro 20x 并开通专属分组{groupName}，未成团将由管理员全额原路退款。服务期从实际开通起计算 30 天。严禁生成违法违规内容；因用户违规导致风控或封号，一律不退款。非用户违规导致的官方风控或封号，是否退款由官方决定；官方审核通过后按实付金额和剩余服务天数退款。',
      groupName: '【codex】【拼车专用】codex-pro 倍率为0',
      formationWindow: '首位付款后 48 小时成团',
      planName: '{count} 人套餐',
      credentialsAvailable: '可提供账号密码',
      person: '人',
      servicePeriod: '服务期 30 天，完全按照官方套餐5小时，7天额度。',
      progress: '当前进度',
      remaining: '还差 {count} 人成团',
      formed: '本团已成团',
      deadline: '截止 {time}',
      immediateFormation: '付款后立即成团，无需等待',
      join: '参与拼车',
      noPlans: '暂无可购买的拼车套餐',
      alipayUnavailable: '当前没有可用的人民币支付宝通道，暂时无法购买拼车套餐。',
      myGroups: '我的拼车',
      waitingDetail: '还差 {count} 人，成团截止 {time}',
      purchasingDetail: '拼车成功，管理员采购账号中，稍后将会开通独立分组。',
      activeDetail: '独立分组已开通，服务到期时间 {time}',
      notFormedDetail: '48小时内未成团，等待管理员原路退款。',
      refundPendingDetail: '订单正在等待管理员处理退款。',
      refundedDetail: '退款已按原支付通道处理。',
      expiredDetail: '30天服务期已结束。',
      status: {
        waiting: '待成团',
        purchasing: '采购账号中',
        active: '已开通',
    ...
    errors: {
      ...
      INVALID_CARPOOL_PLAN: '拼车套餐无效',
      INVALID_CARPOOL_PLAN_AMOUNT: '套餐总金额必须大于 0，且最多保留两位小数',
      INVALID_CARPOOL_PLAN_MEMBERS: '成团人数必须是大于 0 的整数',
      INVALID_CARPOOL_PLAN_NOTE: '套餐备注不能为空',
      CARPOOL_PLAN_NOT_FOUND: '拼车套餐不存在',
      CARPOOL_PLAN_CHANGED: '拼车套餐刚刚发生变化，请刷新后重新下单',
      CARPOOL_PLAN_IN_USE: '该套餐存在待处理订单或待成团拼车，暂时不能修改或删除',
      CARPOOL_ALIPAY_ONLY: '拼车订阅仅支持支付宝',
      CARPOOL_CNY_ONLY: '拼车订阅需要人民币支付通道',
      CARPOOL_PENDING_ORDER_EXISTS: '请先完成或取消当前待支付的拼车订单',
      CARPOOL_ALREADY_JOINED: '您已经加入当前拼车团，不能重复占位',
      CARPOOL_GROUP_CHANGED: '当前拼车团状态已变化，请刷新后重试',
      INVALID_CARPOOL_STATUS: '当前拼车状态不允许此操作',
      INVALID_CARPOOL_PERIOD: '拼车服务时间无效',
    ...
    admin: {
      ...
      carpool: {
        ...
        editPlan: '编辑套餐',
        deletePlan: '删除套餐',
        deletePlanConfirm: '确认删除这个套餐吗？已有历史拼车记录不会受影响。',
        totalAmount: '整团总金额',
        groupSize: '成团人数',
        perMemberAmount: '每人金额',
        perMemberPreview: '每位用户支付 {amount}',
        planNote: '套餐备注',
        planNotePlaceholder: '填写成团、账号交付、违规和退款规则',
        updatedAt: '更新时间',
        members: '人已付款',
        deadline: '成团截止',
        formedAt: '成团时间',
        openedAt: '开通时间',
        serviceExpiresAt: '服务到期',
        statusReason: '状态原因',
        markOpened: '标记已开通',
        markRefundPending: '进入退款处理',
        openDialogTitle: '确认开通拼车服务',
        openDialogMessage: '确认账号已采购并完成专属分组配置。确认后立即开始计算 30 天服务期。',
        refundPendingDialogTitle: '确认进入退款处理',
        refundAmountHint: '未成团按全额退款；官方审核通过后，按剩余服务天数填写退款金额。',
        notFormed: '48 小时内未成团',
        notFormedRefundReason: '48 小时内未成团，全额原路退款',
      },
      refundInfo: '退款信息',
      refundEnabled: '允许退款',
