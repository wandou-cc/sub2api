  ...
  <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xl font-bold text-gray-900 dark:text-white">&yen;{{ formatMoney(stats.total_amount) }}</p>
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        ...
        <div>
          <p class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ t('payment.admin.payingUsers') }}</p>
          <p class="text-xl font-bold text-gray-900 dark:text-white">{{ stats.user_count }}</p>
        </div>
      </div>
    </div>
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xl font-bold text-gray-900 dark:text-white">&yen;{{ formatMoney(stats.avg_amount) }}</p>
        </div>
      </div>
    </div>
  </div>
