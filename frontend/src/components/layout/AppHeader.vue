    ...
    <div class="flex h-16 items-center justify-between gap-2 px-2 sm:px-4 md:px-6">
      ...
      <div class="flex min-w-0 items-center gap-1 sm:gap-3">
        ...
        <a
          ...
          class="hidden items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-sm font-medium text-[var(--app-muted)] transition-colors hover:bg-[var(--app-surface-muted)] hover:text-[var(--app-ink)] sm:flex"
        >
        ...
        <div
          v-if="user"
          class="group relative hidden items-center gap-2 rounded-xl border border-[var(--app-line)] bg-[var(--app-surface)] px-3 py-1.5 sm:flex"
        >
          <svg
