...
const docsSections = computed<DocsSection[]>(() => [
  {
    id: 'activities',
    title: '活动规则',
    description: '站内充值盲盒等活动的资格、概率、奖励和退款处理规则。',
    icon: 'cube',
    pages: [
      {
        id: 'recharge-lottery',
        title: '盲盒抽奖完整规则',
        summary: '每笔余额充值对应一个盲盒，充值金额决定稀有度上限与奖励范围。',
        lead: '余额充值订单真正完成到账后，系统会为该订单创建一个未领取盲盒。只有用户点击礼盒并领取成功后，奖励才会以余额形式加入当前账户。',
        blocks: [
          {
            heading: '参与资格',
            items: [
              '仅余额充值订单参与，订阅购买不产生盲盒。',
              '订单状态达到“已完成”时产生 1 个盲盒；同一订单不会重复产生资格。',
              '充值完成只生成领取资格，不会自动发放盲盒奖励；关闭领取弹窗也不会发放。',
              '用户点击礼盒领取成功后才发放奖励，每个盲盒只能派奖一次。',
              '活动上线前已经完成的历史充值订单不补发盲盒。',
              '未退款且保持已完成状态的订单，其未开启盲盒不设置额外领取期限。',
            ],
          },
          {
            heading: '低于 $5：最高稀有',
            paragraphs: ['本档总奖励范围为 $0.10–$0.30。'],
            items: [
              '普通：80%，奖励 $0.10–$0.18。',
              '稀有：20%，奖励 $0.19–$0.30。',
            ],
          ...
          {
            heading: '$5–< $20：最高史诗',
            paragraphs: ['本档总奖励范围为 $0.20–$1.00。金额达到 $5 即进入本档。'],
            items: [
              '普通：65%，奖励 $0.20–$0.40。',
              '稀有：28%，奖励 $0.41–$0.70。',
              '史诗：7%，奖励 $0.71–$1.00。',
          ...
          {
            heading: '$20–< $100：最高史诗+',
            paragraphs: ['本档总奖励范围为 $0.50–$4.00。金额达到 $20 即进入本档。'],
            items: [
              '普通：50%，奖励 $0.50–$1.00。',
              '稀有：32%，奖励 $1.01–$1.80。',
              '史诗：15%，奖励 $1.81–$2.80。',
          ...
          {
            heading: '$100–< $500：最高传说',
            paragraphs: ['本档总奖励范围为 $2.00–$18.00。金额达到 $100 即进入本档。'],
            items: [
              '普通：40%，奖励 $2.00–$4.00。',
              '稀有：30%，奖励 $4.01–$7.00。',
              '史诗：18%，奖励 $7.01–$10.50。',
          ...
          {
            heading: '$500 及以上：最高传说',
            paragraphs: ['本档总奖励范围为 $8.00–$60.00。金额达到 $500 即进入本档。'],
            items: [
              '普通：20%，奖励 $8.00–$14.00。',
              '稀有：28%，奖励 $14.01–$22.00。',
              '史诗：27%，奖励 $22.01–$32.00。',
              '史诗+：18%，奖励 $32.01–$45.00。',
              '传说：7%，奖励 $45.01–$60.00。',
            ],
          },
          {
            heading: '抽取与到账',
            items: [
              '档位按该笔订单实际到账的美元余额确定，区间采用左闭右开；例如 $20.00 进入 $20–< $100 档。',
              '系统先按公布概率抽取稀有度，再在对应奖励范围内按美分随机生成金额。',
              '单次奖励不会超过该笔充值的实际到账余额。',
              '开奖结果、奖励金额和领取后余额会一并保存；重复提交同一盲盒只会返回原结果，不会重复到账。',
            ],
          },
          {
            heading: '退款处理',
            items: [
              '全额退款会扣回该订单已经领取的全部盲盒奖励。',
              '部分退款会按退款金额占原订单金额的比例扣回已领取奖励。',
              '订单进入退款流程后，尚未开启的盲盒不再可用。',
              '发起退款时，账户余额必须足以覆盖退款金额和应扣回的盲盒奖励。',
            ],
          },
        ],
      },
