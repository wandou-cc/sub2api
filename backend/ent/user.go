...
type UserEdges struct {
	...
	// RechargeLotteryDraws holds the value of the recharge_lottery_draws edge.
	RechargeLotteryDraws []*RechargeLotteryDraw `json:"recharge_lottery_draws,omitempty"`
...
// RechargeLotteryDrawsOrErr returns the RechargeLotteryDraws value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) RechargeLotteryDrawsOrErr() ([]*RechargeLotteryDraw, error) {
	if e.loadedTypes[10] {
		return e.RechargeLotteryDraws, nil
	}
	return nil, &NotLoadedError{edge: "recharge_lottery_draws"}
}
...
// QueryRechargeLotteryDraws queries the "recharge_lottery_draws" edge of the User entity.
func (_m *User) QueryRechargeLotteryDraws() *RechargeLotteryDrawQuery {
	return NewUserClient(_m.config).QueryRechargeLotteryDraws(_m)
}
